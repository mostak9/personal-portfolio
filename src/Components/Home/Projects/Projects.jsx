          ...
          <Card className=" overflow-hidden">
            ...
            <CardBody>
              ...
              <Typography
                ...
                className="mt-3 font-normal"
              >
                Online library, JWT-secured for privacy. Browse PDF books, MongoDB powered. Borrow one book at a time for fair access.
              </Typography>
              <div className="flex items-center gap-2 mt-4">
          ...
          <Card className=" overflow-hidden">
            ...
            <CardBody>
              ...
              <Typography
                ...
                className="mt-3 font-normal"
              >
             Quantum Drive is a brandshop. Explore products. Registered users: ADD PRODUCT, manage cart. Database-driven.
              </Typography>
              <div className="flex items-center gap-2 mt-4">
